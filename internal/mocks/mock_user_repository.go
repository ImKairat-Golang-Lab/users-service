...
// Source: internal/ports/user_repository.go
...
func (m *MockUserRepository) FindByEmail(ctx context.Context, email string) (ports.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindById(ctx context.Context, id string) (ports.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) Save(ctx context.Context, user ports.User) error {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) Update(ctx context.Context, user ports.User) error {
	m.ctrl.T.Helper()
